...
var SpaceBackgroundStateContext = /*#__PURE__*/React.createContext(initialContext);
var SpaceBackgroundDispatchContext = /*#__PURE__*/React.createContext(function () {});
...
function SpaceBackgroundProvider(_ref) {
  ...
  var _useReducer = React.useReducer(spaceBackgroundReducer, _extends({}, initialContext)),
      state = _useReducer[0],
      dispatch = _useReducer[1];

  return React__default.createElement(SpaceBackgroundStateContext.Provider, Object.assign({
    value: state
  }, props), React__default.createElement(SpaceBackgroundDispatchContext.Provider, {
    value: dispatch
  }, children));
}
function useSpaceBackgroundState() {
  var context = React.useContext(SpaceBackgroundStateContext);
...
function useSpaceBackgroundDispatch() {
  var context = React.useContext(SpaceBackgroundDispatchContext);
...
exports.SpaceBackgroundDispatchContext = SpaceBackgroundDispatchContext;
exports.SpaceBackgroundProvider = SpaceBackgroundProvider;
exports.SpaceBackgroundStateContext = SpaceBackgroundStateContext;
exports.Star = Star;
exports.fillStars = fillStars;
exports.initialContext = initialContext;
exports.renderStar = renderStar;
exports.setCanvasDimensions = setCanvasDimensions;
exports.useSpaceBackgroundContext = useSpaceBackgroundContext;
exports.useSpaceBackgroundDispatch = useSpaceBackgroundDispatch;
exports.useSpaceBackgroundState = useSpaceBackgroundState;
//# sourceMappingURL=react-space-background.cjs.development.js.map
